...
export default function AddUserModal({ open, handleClose }) {
  ...
  return (
    <Modal open={open} onClose={handleClose} className="!w-1/2 !mt-36">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="w-full flex flex-row justify-end mt-5">
            <button
              ...
              className="w-1/5 h-10 rounded-md mr-4 border-solid border border-slate-300 hover:bg-slate-200 transition-all duration-300"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="w-1/5 h-10 rounded-md bg-blue-700 text-white hover:bg-blue-800 transition-all duration-300"
            >
              Create
            </button>
          </div>
